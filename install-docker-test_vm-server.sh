...
# Run this on the server: ssh root@66.179.80.249
...
echo "     scp -i ~/.ssh/id_gprs_server install-docker-on-server.sh root@66.179.80.249:~/"
echo ""
echo "  2. SSH into the server:"
echo "     ssh -i ~/.ssh/id_gprs_server root@66.179.80.249"
echo ""

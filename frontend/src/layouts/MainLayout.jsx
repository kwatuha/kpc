      ...
      >
        <Toolbar sx={{ p: 0, minHeight: '48px !important', height: '48px' }}>
          <Box sx={{ display: 'flex', alignItems: 'center', width: '100%' }}>
            ...
            >
              {!headerGovLogoFailed && (
                /* White "badge" wrapper keeps the KEMRI emblem readable
                   against any AppBar background. Kept compact (≈36px overall)
                   so the slim 48px AppBar stays clean — the legible identity
                   is carried by the adjacent KIMES wordmark. */
                <Box
                  sx={{
                    display: 'flex',
                    alignItems: 'center',
                    ...
                    borderRadius: '50%',
                    p: '2px',
                    boxShadow: '0 1px 3px rgba(0,0,0,0.25), 0 0 0 1px rgba(255,255,255,0.7)',
                    flexShrink: 0,
                  }}
                >
                  <Box

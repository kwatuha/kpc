...
const Sidebar = ({ expandedSidebarWidth = 200, treeSidebarFlushTop = false, isPinnedOpen = false, onTogglePinned }) => {
  ...
  const treeBrandLogoH = treeSidebarFlushTop ? 36 : 32;
          ...
          {isTreeLayout ? (
            <>
              ...
              {!isCollapsed ? (
                ...
                >
                  {/* White circular "badge" so the emblem stays legible on dark/blue chrome */}
                  <Box
                    sx={{
                      display: 'flex',
                      alignItems: 'center',
                      ...
                      borderRadius: '50%',
                      p: '3px',
                      boxShadow: '0 1px 4px rgba(0,0,0,0.25), 0 0 0 1px rgba(255,255,255,0.7)',
                      flexShrink: 0,
                    }}
                  >
                    <Box
                ...
                <Tooltip title="KIMES" placement="right" arrow>
                  <Box
                    sx={{
                      display: 'flex',
                      justifyContent: 'center',

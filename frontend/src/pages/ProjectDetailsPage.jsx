...
// KEMRI / KIMES data-collection categories that are valid choices when
// attaching a checklist to a project inspection. Matches the seed in
// api/migrations/20260510_kemri_data_collection_templates.sql.
const KEMRI_INSPECTION_CATEGORIES = new Set([
    'pi_visit',
    'cd_visit',
    'mel_audit',
    'compliance',
                    ...
                    setInspectionTemplates(
                        rows.filter(
                            (t) =>
                                ...
                                // KEMRI / KIMES checklists also fit a project-attached
                                // inspection (PI visits, CD visits, MEL audits, lab QC,
                                // equipment audits, compliance, study closure …).
                                KEMRI_INSPECTION_CATEGORIES.has(t.templateCategory)
                        )
                    );
                }
            } catch {
